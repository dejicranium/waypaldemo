...
import { isoToDate, formatCurrency, formatAmount } from "../assets/js/utils";

const TripDetailHeader = ({ trip, user }) => {
  return (
    <>
      <h1 className="font-circular-black text-black text-3xl md:pr-14">
        {trip.destination} {formatCurrency(trip.currency)}{formatAmount(trip.travel_amount + trip.miscellaneous_amount + trip.accommodation_amount)}
      </h1>
